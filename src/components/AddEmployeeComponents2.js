  ...
  return (
    <div>
          ...
          <div className="card col-md-6 offset-md-3 offset-md-3">
            ...
            <div className="card-body">
              <form>
                ...
                <Link to="/semi-user-dashboard" className="btn btn-danger">
                  Cancel
                </Link>
              </form>
            </div>
      ...
      <div className="text-center mt-3">
        <Link to="/semi-user-dashboard" className="btn btn-primary">
          SemiUserDashboard
        </Link>
      </div>
    </div>
...
export default AddEmployeeComponents2;